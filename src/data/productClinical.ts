...
export const PRODUCT_CLINICAL: Partial<
  Record<Product["nameKey"], ProductClinical>
> = {
  "product.bifidumBakterin": {
    ru: {
      ...
      keyBacteria: "Bifidobacterium adolescentis, B. longum, B. bifidum",
  ...
  "product.biobalans": {
    ru: {
      program: "2. Для укрепления иммунитета",
      audience: "Детям и взрослым для витаминной поддержки и иммунитета.",
      keyBacteria:
    ...
    en: {
      program: "2. Immune support",
      audience: "Children and adults for vitamin support and immunity.",
      keyBacteria:
        "B. bifidum, B. adolescentis, L. acidophilus, L. bulgaricum, Streptococcus thermophilus",
  ...
  "product.laktoBakterin": {
    ru: {
      ...
      effect: "Создаёт благоприятную среду для женского организма.",
    },
    en: {
  ...
  "product.megaLakto300": {
    ...
    en: {
      ...
      audience:
        "For supporting vaginal microflora and overall women’s wellness.",
      keyBacteria: "Lactobacillus plantarum, Lactobacillus fermentum",
      effect: "Supports women’s microflora. With Mega Bifidum: gut support.",
    },
  },
  "product.probinavLb": {
    ru: {
      program:
        "4. Восстановление после болезней (ОРВИ, антибиотики, дисбактериоз)",
      audience: "После инфекций, антибиотиков или при дисбактериозе.",
  ...
  "product.baktrisubtil": {
    ru: {
      ...
      audience: "При дисбактериозе и в программах восстановления кишечника.",
  ...
  "product.probinav7": {
    ru: {
      program: "4. Восстановление после болезней",
      audience: "После антибиотиков, операций, при дисбактериозе.",
      keyBacteria:
  ...
  "product.megavitaSashe": {
    ru: {
      ...
      effect: "Приготовление йогурта дома; поддержка микрофлоры.",
    },
    en: {
